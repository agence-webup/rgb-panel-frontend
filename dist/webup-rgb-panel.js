  ...
  var WebupRgbPanel = /*#__PURE__*/function () {
    ...
    _createClass(WebupRgbPanel, [{
      ...
      value: function bindEvents() {
        ...
        this.ui.inputColor.addEventListener('change', function () {
          _this.setColor(_this.ui.inputColor.value);
        });
        this.ui.inputColor.addEventListener('input', function () {
          _this.setColor(_this.ui.inputColor.value);
        });
        this.ui.btnSize1.addEventListener('click', function () {
          _this.setThickness(1);
        });
        this.ui.btnSize2.addEventListener('click', function () {
          _this.setThickness(2);
        });
        this.ui.btnSize3.addEventListener('click', function () {
          _this.setThickness(3);
        });
        this.ui.btnPencil.addEventListener('click', function () {
          if (_this.mode !== 1) {
            _this.mode = 1;

            if (_this.ui.btnErase.classList.contains('toolSelected')) {
              _this.ui.btnErase.classList.remove('toolSelected');
            }

            _this.ui.btnPencil.classList.add('toolSelected');
          }
        });
        this.ui.btnErase.addEventListener('click', function () {
          if (_this.mode !== 0) {
            _this.mode = 0;

            if (_this.ui.btnPencil.classList.contains('toolSelected')) {
              _this.ui.btnPencil.classList.remove('toolSelected');
            }

            _this.ui.btnErase.classList.add('toolSelected');
          }
        });
